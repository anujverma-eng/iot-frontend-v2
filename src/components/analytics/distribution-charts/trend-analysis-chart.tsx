...
export const TrendAnalysisChart: React.FC<TrendAnalysisChartProps> = ({ config, compact = false }) => {
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
                  <div className="flex items-center gap-2">
                    <div className="p-2 rounded-lg bg-primary-50 text-primary">
                      <Icon 
                        icon={
                          trendData.trendDirection === 'up' ? 'lucide:trending-up' : 
                          trendData.trendDirection === 'down' ? 'lucide:trending-down' : 
                          'lucide:minus'
                        } 
                        width={18} 
                      />
                    ...
                    <div>
                      ...
                      <p className="text-xs text-default-500">
                        Based on {config.series.length} data points
                      </p>
                    </div>
                  </div>
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Line 
                ...
                dataKey="trend" 
                stroke={
                  trendData.trendDirection === 'up' ? '#10b981' : 
                  trendData.trendDirection === 'down' ? '#ef4444' : 
                  '#6b7280'
                } 
                strokeWidth={2} 
                strokeDasharray="5 5"
