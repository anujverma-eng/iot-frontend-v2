...
export default function DashboardInvitationsPage() {
  ...
  // Data is fetched by DashboardLayout - no need to fetch here
  // This prevents duplicate loading when redirected from PublicInvitePage
  useEffect(() => {
    // No-op - data is managed by DashboardLayout
  }, []);
  ...
  // This prevents showing loading spinner when data is already available
  const shouldShowLoading = myInvitationsLoading && (!myInvitations || myInvitations.length === 0);
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
          ...
          <Card>
            <CardBody>
              <div className="text-center py-12">
                ...
                {/* Note: Dashboard users don't get "Create New Organization" option - they use main onboarding flow */}
              </div>
            </CardBody>
          </Card>
        ) : (
        ...
        {/* NO "Create New Organization" section for dashboard users */}
      </div>
